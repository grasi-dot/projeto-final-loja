...
let apotecarys = [
  {
    id: 1,
    name: "Diarios de uma apotecária 1",
    image: "apotecary-1.webp",
    category: "Diarios de uma apotecária",
    price: 4090
  },
  {
    id: 18,
    name: "Diarios de uma apotecária 2",
    image: "apotecary-2.webp",
    category: "Diarios de uma apotecária",
    price: 4090
  },
  {
    id: 3,
    name: "Diarios de uma apotecária 3",
    image: "apotecary-3.webp",
    category: "Diarios de uma apotecária",
    price: 4090
  },
  {
    id: 4,
    name: "Diarios de uma apotecária 4",
    image: "apotecary-4.webp",
    category: "Diarios de uma apotecária",
    price: 4090
  },
]
...
const iniTabApotecary = () => {
  apotecarys.forEach((apotecary, key) => {
    const { image, category, name, price } = apotecary;
    let newDiv = document.createElement("div");
    newDiv.classList.add("item");
    newDiv.innerHTML = `
      <img src="./img/store/${image}">
...
const iniTabJujutsu = () => {
  jujutsus.forEach((jujutsu, key) => {
    const { image, category, name, price } = jujutsu;
    let newDiv = document.createElement("div");
    newDiv.classList.add("item");
    newDiv.innerHTML = `
      <img src="./img/store/${image}">
...
const initTabSolo = () => {
  solos.forEach((solo, key) => {
    const { image, category, name, price } = solo;
    let newDiv = document.createElement("div");
    newDiv.classList.add("item");
    newDiv.innerHTML = `
      <img src="./img/store/${image}">
